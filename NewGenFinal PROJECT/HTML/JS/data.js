document.addEventListener('DOMContentLoaded', () => {
    ...
    form.addEventListener('submit', function (event) {
        ...
        dci.innerHTML = "Daily Caloric Intake: " + calories.toFixed(2);
        c.innerHTML = "Daily Carbohydrates Intake: " + carbs.toFixed(2);
        p.innerHTML = "Daily Proteins Intake: " + proteins.toFixed(2);
        f.innerHTML = "Daily Fats Intake: " + fats.toFixed(2);
